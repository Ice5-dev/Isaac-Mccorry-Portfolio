# Isaac McCorry — Portfolio iterations

Each folder is a self-contained version of the portfolio. The root `index.html` remains the original main site.

| Version | Live page | Focus |
| --- | --- | --- |
| v1 | [View v1](https://ice5-dev.github.io/Isaac-Mccorry-Portfolio/v1/) | First portfolio created from the résumé |
